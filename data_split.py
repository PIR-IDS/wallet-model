...
validation and test. These data would be saved separately under "/output/data".
...
if __name__ == "__main__":
    data = read_data("./output/data/complete_data")
    train_data, valid_data, test_data = split_data(data, 0.6, 0.2)
    write_data(train_data, "./output/data/train")
    write_data(valid_data, "./output/data/valid")
    write_data(test_data, "./output/data/test")
